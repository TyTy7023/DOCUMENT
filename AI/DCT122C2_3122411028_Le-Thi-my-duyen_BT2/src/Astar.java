...
public class Astar {
    ...
    Object[] title = {"BƯỚC", "ĐỈNH V ", "OPENED", "CLOSED"}; // Create a string array to store the title of the table
    ...
    public void solve8Puzzle() {
        ...
        while (!open.isEmpty()) {
            ...
            if (current.isGoal(target)) {
                ...
                LinkedList<States> temp = new LinkedList<>();
                ...
                for (States state : temp) {
                    System.out.print("(" +state+ ")");
                    if (state.equals(temp.getLast())) {
                        System.out.print("\n");
                    }
                    else {
                        System.out.print(" -> ");
                ...
                System.out.println("DO YOU WANT TO PRINT THE BOARD OF PATH? (Y/N)");
