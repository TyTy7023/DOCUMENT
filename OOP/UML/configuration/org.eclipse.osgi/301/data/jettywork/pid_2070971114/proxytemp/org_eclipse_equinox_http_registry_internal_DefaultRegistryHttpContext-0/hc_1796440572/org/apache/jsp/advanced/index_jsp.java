...
String  direction = isRTL?"rtl":"ltr";
 ...
 if (data.isIE() || data.isMozilla() && "1.2.1".compareTo(data.getMozillaVersion()) <=0){
      ...
      out.write("\t\n");
      out.write("    try {\n");
      out.write("        var h=window.HelpToolbarFrame.SearchFrame.document.getElementById(\"searchLabel\").offsetHeight; ");
      out.write("\n");
      out.write("\t    if(h<=19){\n");
      ...
      out.write("(11+h)+\",*");
      out.print(data.getFooterRowText());
      out.write("\" ); ");
      out.write("\n");
      out.write("        }\n");
      out.write("    }\n");
...
// restore mozilla from minimized
      ...
      out.write("\n");
      out.write("    try {\n");
      out.write("\t    window.HelpToolbarFrame.frames[\"SearchFrame\"].document.getElementById(\"searchWord\").focus();\n");
      out.write("\t} catch (e) {\n");
      out.write("\t}\n");
      out.write("}\n");
      out.write("\n");
	...
	if(!("0".equals(data.getBannerHeight()))){
      ...
      out.write("\n");
      out.write("\t<frame name=\"HelpToolbarFrame\" title=\"");
      out.print(ServletResources.getString("ignore", "HelpToolbarFrame", request));
      out.write("\" src='");
      out.print("advanced/helpToolbar.jsp"+UrlUtil.htmlEncode(data.getQuery()));
	...
	if(!("0".equals(data.getFooterHeight()))){
      ...
      out.write("\n");
      out.write("\t<frame name=\"FooterFrame\" title=\"");
      out.print(ServletResources.getString("Footer", request));
      out.write("\" src='");
      out.print(data.getFooterURL());
      out.write("'  marginwidth=\"0\" marginheight=\"0\" scrolling=\"no\" frameborder=\"0\" noresize=0>\n");
